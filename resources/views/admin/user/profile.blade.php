    ...
    <div class="page-inner mt--5">
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="card card-stats card-round mt-3">
                    <div class="card-body">
                        <h3>Data Wilayah</h3>
                        <div class="form-group">
                            <label>Kode Wilayah</label>
                            <input type="text" class="form-control" value="{{ $pengguna->wilayah->kode_wilayah }}"
                                disabled>
                        </div>
                        <div class="form-group">
                            <label>Nama Wilayah</label>
                            <input type="text" class="form-control" value="{{ $pengguna->wilayah->nama_wilayah }}"
                                disabled>
                        </div>
                    </div>
                </div>
